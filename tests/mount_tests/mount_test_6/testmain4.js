...
const jsCalc = {
    ...
    initState: function () {
        ...
        let dom_tree = makeNewTree('0', '0', new DomTree('div', jsCalc.mountPoint));
        vdom.mount(dom_tree, dom_tree.getRoot());

        return jsCalc.currentTree = dom_tree;    
    },
    setOperand(val) {
        if (this.operand == ('' || '0')) {
            this.operand = val;
        ...
        //console.log(this.currentTree);
        this.updateDisplay(jsCalc.operand, jsCalc.result, new DomTree('div', jsCalc.mountPoint));
    },
    setResult(val) {
        this.result = val;
        jsCalc.updateDisplay(jsCalc.operand, jsCalc.result, new DomTree('div', jsCalc.mountPoint));
    },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    set_event_listeners(document, function() {jsCalc.setOperand(this.value)});
