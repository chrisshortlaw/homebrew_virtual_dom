...
const vdom = {
    ...
    */ 
    patch: function(oldNode, newNode) {
        ...
        const parentNode = new_el.parentNode;
...
function changePage(mountNode, newMount, vdomfunc) {
    ...
    vdom.patch(mountNode, newMount);
    

} /* ------- END OF changePage() Function ------------------ */  /* ----------------------------------------------------------------------------------------------------------------- END OF changePage() Function ------------------ */
...
/* ----------------------------------------------------------------------------------------------- Basic Display Components --------------------------- */
    ...
    setTimeout(function () {
        ...
        changePage(dom_tree, dom_tree2, vdom)
    }, 5000);

    setTimeout(function () {
        console.log('ChangePage has fired');
        changePage2(dom_tree2, dom_tree3, vdom)
    }, 7000);

    const dom_tree3 = new DomTree('div', mountPoint);

    function changePage2(mountNode, newMount, vdomfunc) {
